...
import (
	"linkedInLearning/tempService10/data"
	"sort"
	"strings"
)
...
// Filter process the city query and returns the list of matching cities.
...
// of the query parameter flags on the list of cities.
...
// nameContains checks whether the given CityQuery name is contained in the CityTemp name
func nameContains(rc CityTemp, q CityQuery) bool {
	return strings.Contains(strings.ToLower(rc.Name()), strings.ToLower(q.Name()))
}
